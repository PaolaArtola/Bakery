...
<template>
  <div class="w-full flex flex-col justify-centerjustify-between items-center">
    ...
    <div class="bg-gradient-to-b from-white to-[#ffccd3] w-full aspect-[15/2] overflow-hidden">
      <waveDivider />
    </div>
    <div class="w-full bg-[#ffccd3]">
      <!-- BEST SELLERS -->
      <section class="pb-20 px-4 flex justify-center">
      ...
      <!-- SPECIAL ORDERS -->
      <section class="py-24 px-4 flex justify-center">
        <div
